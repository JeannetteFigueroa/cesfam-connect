...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const signIn = async (email: string, password: string) => {
    try {
      ...
      // Pasar el token recién recibido para evitar condiciones de carrera
      await fetchUserData();
      ...
      if (error.message === "Failed to fetch") {
        return { error: `No se puede conectar con el servidor. Asegúrate de que el backend Django esté corriendo en ${API_BASE_URL}` };
      }
